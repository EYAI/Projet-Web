        ...
        <!-- Begin Page Content -->
          ...
          <div class="card shadow-lg h-75 m-4 mt-8">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success">Liste des commentaires</h6>
            </div>
            <div class="card-body">
                    ...
                    <?php
                      foreach($liste as $row){ ?>
                        <tr>
                          ...
                          <a href="SupprimerCommentaire.php?MSG=<?php echo $row['MSG']; ?>" class="btn btn-danger btn-icon-split" value="<?php echo $row['MSG']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer ?');">
