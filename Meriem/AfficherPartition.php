...
include "D:\wamp64\www\Melodyo\Core\config.php";
    ...
    $liste = $PartitionOPS->getPartition();
        ...
        <!-- Begin Page Content -->
          ...
          <div class="card shadow-lg h-75 m-4 mt-8">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-success">Liste Compositeur</h6>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                      foreach($liste as $row){ ?>
                        <tr>
                          <td><?php echo $row['RefPart']; ?></td>
                          <td><?php echo $row['NomPart']; ?></td>
                          <td><?php echo $row['Niveau']; ?></td>
                          <td><?php echo $row['DispoPart']; ?></td>
                          <td><?php echo $row['Prix']; ?></td>
                          <td><?php echo $row['IdCom']; ?></td>
                          <td>
                            <a href="MoPartition.php?RefPart=<?php echo $row['RefPart']; ?>" class="btn btn-info btn-icon-split">
                            <a href="MoPartition.php?RefPart=<?php echo $row['RefPart']; ?>" class="btn btn-info btn-icon-split">
                              <span class="icon text-white-50">
                                <i class="fas fa-fw fa-wrench"></i>
                            </a>
                          <a href="javascript:void(0);" id="dellink<?php echo $row['RefPart']; ?>" class="btn btn-danger btn-icon-split" onclick="delconfirm('<?php echo $row['RefPart']; ?>','Partition')">
                          <a href="SuppPartition.php?RefPart=<?php echo $row['RefPart']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('voulez vous vraiment supprimer?')">
                          <span class="icon text-white-50">
