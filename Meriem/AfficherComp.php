                  ...
                  <?php
                      foreach($liste as $row){ ?>
                        <tr>
                          ...
                          <td><?php echo $row['Epoque']; ?></td>
                          <td>
                            <a href="MoComp.php?IdCom=<?php echo $row['IdCom']; ?>" class="btn btn-info btn-icon-split">
                            <a href="MoComp.php?IdCom=<?php echo $row['IdCom']; ?>" class="btn btn-info btn-icon-split">
                              <span class="icon text-white-50">
                                <i class="fas fa-fw fa-wrench"></i>
                            </a>
                          <a href="javascript:void(0);" id="dellink<?php echo $row['IdCom']; ?>" class="btn btn-danger btn-icon-split" onclick="delconfirm('<?php echo $row['IdCom']; ?>','Compositeur')">
                          <a href="SuppComp.php?IdCom=<?php echo $row['IdCom']; ?>" class="btn btn-danger btn-icon-split" onclick="return confirm('voulez vous vraiment supprimer?')" >
                          <span class="icon text-white-50">
