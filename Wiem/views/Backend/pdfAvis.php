<?php  
 ...
 {  
      ...
      $sql = "SELECT * FROM avis_client ORDER BY id_avis ASC";  
 ...
 {  
      ...
      $obj_pdf->SetTitle("Liste des Avis");  
      ...
      <h3 align="center">Liste des Avis </h3><br /><br />  
      <table border="1" cellspacing="0" cellpadding="5">  
           <tr>  
                <th width="15%">id_avis</th>  
                <th width="15%">id_produit</th>  
                <th width="15%">id_client</th>  
                <th width="15%">nb_etoile</th>  
           ...
           <div class="container" style="width:700px;">  
                ...
                <div class="table-responsive">  
                     <table class="table table-bordered">  
                          <tr>  
                               <th width="10%">id_avis</th>  
                               <th width="10%">id_produit</th>  
                               <th width="10%">id_client</th>  
                               <th width="10%">nb_etoile</th>  
