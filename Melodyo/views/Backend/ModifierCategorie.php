      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Modification d'une Categorie</h6>
          </div>
          <div class="card-body">
            
            <form action="ModifCategorie.php" method="POST" onsubmit="return validate_formcat()">
                <div class="form-inline">
                <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2"Value=<?php echo $idCategorie;?>  id="Code" placeholder="Code Facture">
                  </div>
                <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="nomCategorie" id="nomCategorie" placeholder="nom Categorie">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="idCategorie" id="idCategorie" placeholder="ID">
                  </div>
