                      ...
                      foreach($liste as $row){ ?>
                       ...
                       <td>
                            <a href="ModifierFournisseur.php?CIN=<?php echo $row['CIN']; ?>" class="btn btn-info btn-icon-split">
                              ...
                              <a href="SuppFournisseur.php?CIN=<?php echo $row['CIN']; ?>" class="btn btn-danger btn-icon-split"onclick="return confirm('Voulez Vous Vraiment Supprimer?')">
                            </span>
                            <span class="icon text-white-50">
