            ...
            <form action="ModiFournisseur.php" method="POST" onsubmit="return validate_formcat()">
                <div class="form-inline">
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" Value=<?php echo $CIN;?> id="CIN" placeholder="CIN">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="nom" id="nom" placeholder="Nom" >
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="nomCategorie" id="nomCategorie" placeholder="nomCategorie">
                  </div>
                  <div class="form-group col-md-6">
