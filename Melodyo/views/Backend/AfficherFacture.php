                  ...
                  <?php
                      foreach($liste as $row){ ?>
                        ...
                        <td><?php echo $row['Code']; ?></td>
                          ...
                          <td>
                            <a href="ModifierFacture.php?Code=<?php echo $row['Code'];?>" class="btn btn-info btn-icon-split">
                           
                              <span class="icon text-white-50">
                                <i class="fas fa-fw fa-wrench"></i>
                                <a href="javascript:void(0);" id="dellink<?php echo $row['Code']; ?>" class="btn btn-danger btn-icon-split">
                          <a href="SuppFacture.php?Code=<?php echo $row['Code'];?>" class="btn btn-danger btn-icon-split"  onclick="return confirm('Voulez Vous Vraiment Supprimer?')">
                          <span class="icon text-white-50">
