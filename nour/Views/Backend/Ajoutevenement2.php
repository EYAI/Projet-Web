      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Ajout d'un Evénement</h6>
          </div>
          <div class="card-body">
            
            <form action="Ajoutevenement.php" method="POST" enctype="multipart/form-data">
                
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <input type="number" class="form-control mt-2 mb-2" name="ide" id="ide" placeholder="ID">
                  </div>
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <input type="date" class="form-control mt-2 mb-2" name="datee" id="datee" placeholder="Date">
                  </div>
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <input type="text" class="form-control mt-2 mb-2" name="name" id="name" placeholder="Nom">
                  </div>
                  <div class="form-group col-md-6 mt-2 mb-2">
                    <select name="id" id="id" class="form-control mt-2 mb-2">
                      <option selected value="" disabled>la catégorie d'événement</option>
                      <?php 
