<?php  
 ...
 {  
      ...
      $sql = "SELECT * FROM evenement ORDER BY ide ASC";  
 ...
 {  
      ...
      $obj_pdf->SetTitle("Liste des Evénements");  
      ...
      $content = '';  
      $content .= '  
      <h3 align="center">LISTE DES EVENEMENTS</h3><br /><br />  
      <table border="1" cellspacing="0" cellpadding="5">  
           <tr>  
                <th width="15%">ID</th>  
                <th width="15%">Date</th>  
                <th width="20%">Nom</th> 
                  <th width="15%">ID Categorie</th>  
 ...
 <html>  
      <head>  
           <title>Imprimer Evénement</title>  
