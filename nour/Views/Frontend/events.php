...
<body>
	<div id="wrapper">
		...
		<main id="main">
				...
				<br>
				<br>	
						<p align="center"><a href="../Backend/Ajoutinscription2.php" class="btn-primary text-uppercase text-center lg-round">S'inscrire</a></p>
...
<br>
 ...
 <div style="text-align: center; padding: 16px; " > 
                  ...
                  <h5  style="font-family: Arial, Helvetica sans-serif; font-size: 30px; color: #00cc66 ;"> DATE :   <?=$row['datee']?></a></h5>
                   <div style="text-align: center;" > 
